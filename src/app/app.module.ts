...
import {MatButtonModule, MatMenuModule, MatIconModule, MatInputModule} from '@angular/material';
...
@NgModule({
  ...
  imports: [
    ...
    MatButtonModule, MatMenuModule, MatIconModule, BrowserAnimationsModule, MatInputModule
  ],
